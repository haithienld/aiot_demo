...
def main():
    ...
    parser.add_argument("-e", "--encodings_file", help="path to serialized pickle file of facial encodings.  If the file exists, new encodings will be added.  Otherwise the file will be created", default='encodings/facial_encodings_96.pkl')
    ...
    interpreter_embedding_extractor = make_interpreter('models/FaceNet_128.tflite', device=':0') #facenet_tommy_kr_tpu.tflite efficientnet-edgetpu-M_quant_embedding_extractor_edgetpu FaceNet_128

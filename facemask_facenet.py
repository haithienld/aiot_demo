...
def main():
    ...
    parser.add_argument("-e", "--encodings_file", help="path to serialized pickle file of facial encodings.  If the file exists, new encodings will be added.  Otherwise the file will be created", default=os.path.join(default_model_dir, 'facial_encodings_facenet.pkl'))
